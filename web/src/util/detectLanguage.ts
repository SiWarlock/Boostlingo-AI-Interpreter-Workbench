...
const SPANISH_WORDS = new Set([
  ...
  'en', 'por', 'para', 'con', 'sin', 'su', 'sus', 'es', 'soy', 'eres', 'somos',
  'hola', 'gracias', 'pero', 'porque', 'muy', 'usted', 'ayuda',
])
const ENGLISH_WORDS = new Set([
  'the', 'a', 'an', 'and', 'or', 'of', 'to', 'in', 'on', 'for', 'with', 'is', 'are', 'am',
  'you', 'he', 'she', 'it', 'we', 'they', 'this', 'that', 'hello', 'thanks', 'how', 'where',
  'when', 'why', 'very', 'but', 'because', 'good', 'please',
])
